					...
					<div class="col-xs-12">
						<div class="widget-box widget-color-blue2">
							<div class="widget-header">
								<h4 class="widget-title lighter smaller">更新</h4>
							</div>
							...
							<div class="widget-body">
								<div class="widget-main padding-8">
									<form:form action="./updateBook/${people.id }/${page}"
										id="addForm" commandName="people" method="post"
										autocomplete="off" class="form-horizontal bv-form"
